...
if __name__ == "__main__":
    ...
    res1 = Runner(dicts([("Brute", 51.5), ("Brute", 51.5)]), "CS", setting, test_cases, 60, debug, store).run()
    print("First solved")
    res2 = Runner(dicts([("Brute", 40.7), ("Brute", 47.1)]), "CS", setting, test_cases, 60, debug, store).run()
    print("Second solved")
    res3 = Runner(dicts([("Brute", 38.96), ("AS", 56.74)]), "CS", setting, test_cases, 60, debug, store).run()
    print("Third solved")
    res4 = Runner(dicts([("Brute", 52.9), ("AS", 31.6)]), "CS", setting, test_cases, 60, debug, store).run()
